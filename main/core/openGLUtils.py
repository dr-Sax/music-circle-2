...
class OpenGLUtils(object):
    ...
    # This method is static such that it can be called directly without requiring a class to be created
    @staticmethod
    def initializeShader(shaderCode, shaderType):
        ...
        # stores source code in the shader
        glShaderSource(
            shaderRef, 
            shaderCode
            )
